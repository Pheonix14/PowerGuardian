...
${emojis.timeout} Slowmode Duration: ${duration_word}
**`)
...
await log.send({embeds: [embed]})
  ...
  console.log(error)
      return interaction.editReply({ content: `I Can't Turn On Slowmode On This Channel`, ephemeral: true })
  }
 }
...
await log.send({embeds: [embed]})
  ...
  console.log(error)
      return interaction.editReply({ content: `I Can't Turn Off Slowmode On This Channel`, ephemeral: true })
  }
