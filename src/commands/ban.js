...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("reason").setDescription("A Reason For Getting Banned"),
    )
  ...
  async execute(interaction, client) {
    ...
    if (member.id === interaction.client.user.id)
      return interaction.editReply({
        contest: `**Please Don't Ban Me ;-;**`,
        ephemeral: true,
      });

    if (member.id === interaction.guild.ownerId)
      return interaction.editReply({
        content: `**You Can't Ban Owner Of Server!**`,
        ephemeral: true,
      });
    ...
    try {
      ...
      let embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: `${emojis.banned} Banned Member:`,
            value: `${member.tag}`,
            inline: false,
          },
          {
